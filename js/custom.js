...
$(document).ready(function(){
   ...
   $(".qtyDec, .qtyInc").on("click", function() {
	...
	$('.btn-change-lang').click(function() {
		...
		if (lang == 'es') {
			$('#lang-img').attr('src','images/es-16.png');
			$('#lang-text').text(' Español  (Spanish)');
		} else if (lang == 'en') {
			$('#lang-img').attr('src','images/en-16.png');
			$('#lang-text').text(' Inglés / (English)');
		} else {
			alert('¡Lo sentimos! Hubo un error cambiando el Idioma');
			$('#lang-img').attr('src','images/es-16.png');
			$('#lang-text').text(' Español  (Spanish)');
		}
	});
